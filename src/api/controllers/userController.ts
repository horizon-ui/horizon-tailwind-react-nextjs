...
import { createUserService, deleteUserService, getAllUsers,getUserByPhone, revertDeleteUserService, softDeleteUserService } from "../services/userService"
import { UserData } from "../utils/interface";
import { badRequestError, createCustomError, internalServerError, validationError } from "../utils/error";
import { errorCode100, errorResponseReason } from "../utils/constants/reasonCodes";
 ...
 */
export const getAllUsersController = async (_req: NextApiRequest, res: NextApiResponse) => {
    try {
 ...
 * @param res Next.js API response object
 */
export const getUserByPhoneController = async (_req: NextApiRequest, res: NextApiResponse) => {
    try {
 ...
 * @param res Next.js API response object
 */
export const createUserController = async (_req: NextApiRequest, res: NextApiResponse) => {
    try {
 ...
 * @param res Next.js API response object
 */
export const deleteUserController = async (_req: NextApiRequest, res: NextApiResponse) => {
    try {
 ...
 * @param res Next.js API response object
 */
export const softDeleteUserController = async (_req: NextApiRequest, res: NextApiResponse) => {
    try {
        const { phoneNumber } = _req.query;
 ...
 * @param res Next.js API response object
 */
export const revertDeletedUserController = async (_req: NextApiRequest, res: NextApiResponse) => {
    try {
        const { phoneNumber } = _req.query;
